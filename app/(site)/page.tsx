...
export default async function Home() {
  ...
  return ( <>
    ...
    <Link href={"/menu"} className='border border-black flex gap-3 w-fit mx-auto py-2 px-6 rounded-md sm:my-4 md:my-8 shadow-md active:shadow-none hover:-translate-y-2 transition-all'>
    See our menu <span>&#9832;</span>
      ...
      { events.map((event, i) => (
        <div
        key={i} 
        className='grid sm:grid-cols-1 md:grid-cols-2 justify-between sm:w-fill md:w-10/12 my-4 mx-auto bg-amber-200 p-4 shadow-md'
        >
