  ...
  return (
    <div className="menu h-[100vh] md:h-auto flex flex-wrap gap-2 align-middle  justify-center content-center">
        {menu.map((item, i) => (
            ...
            className="w-[300px] h-[110px] md:h-[300px] text-xl border self-center flex justify-center bg-gray-300 hover:bg-gray-800 hover:text-white transition-all duration-300"
            >
