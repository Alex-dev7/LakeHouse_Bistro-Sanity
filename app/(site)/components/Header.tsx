  ...
  return (
    <header className="flex flex-col align-middle justify-center relative">
            ...
            className="z-10 absolute self-center -translate-x-5 ">
              <Image src={logo} alt="logo" width={700} height={800}  className="logo"/>            
            </div>

            <a        
            href={info.reserve} target="_blank" className="z-10 absolute text-white w-fit mx-auto border-2 border-white px-5 py-2 self-center translate-y-[20vh] rounded-3xl text-lg mt-10 hover:bg-orange-400 hover:opacity-90 transition  shadow-orange-300 shadow-lg">
                Book A Table
            </a>           
